...
**Professional Project — Gear Games**

## Project Overview

A production-grade ETL tool developed for Gear Games analytics department to enable high-volume data extraction from OpenSearch/Elasticsearch clusters. This solution addresses critical performance bottlenecks in analytics data pipelines, achieving a **30x performance improvement** while reducing memory consumption by **55%**. The tool is actively used by the analytics team for data research and by automated scripts for scheduled data processing.

---

## Business Challenge

**Context:** Gear Games analytics team required large-scale historical data extraction from sharded OpenSearch indexes for research and reporting.
...
- **Scalability:** Analytics team extracted **9.1+ billion rows in 1 month** (automated scripts usage not included in metrics)
...
- **Active Usage:** Daily operations by analytics department and production scripts at Gear Games
...
Real-world production metrics at Gear Games:

- **Total extractions (1 month):** 9.124 billion rows by analytics team
- **Note:** Automated scripts also use this tool, but their usage is not included in these metrics
